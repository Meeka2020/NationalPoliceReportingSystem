    ...
    public class PdfService
    {
        public static async Task GeneratePdfAsync(PoliceReport report)
        {
            ...
            try
            {
                ...
                var imageData =
                    ImageDataFactory.Create(memory.ToArray());
            ...
            // REPORTER
            // =========================
            document.Add(new Paragraph("Reporter Details").SetFontSize(12));
            ...
            // INCIDENT
            // =========================
            document.Add(new Paragraph("Incident Details").SetFontSize(12));
            document.Add(new Paragraph($"Type: {report.IncidentType}"));
            document.Add(new Paragraph(
                $"Date: {report.IncidentDate:yyyy-MM-dd}"));
            document.Add(new Paragraph($"Location: {report.IncidentLocation}"));
            document.Add(new Paragraph($"Description: {report.Description}"));
            ...
            // STATUS
            // =========================
            document.Add(new Paragraph("Status: Submitted").SetFontSize(12));
            document.Add(new Paragraph(
